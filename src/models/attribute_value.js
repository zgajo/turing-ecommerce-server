module.exports = (sequelize, DataTypes) => {
	const AttributeValue = sequelize.define('attribute_value', {
		attribute_id: { allowNull: false, type: DataTypes.INTEGER },
		attribute_value_id: { allowNull: false, autoIncrement: true, primaryKey: true, type: DataTypes.INTEGER },
	...
	AttributeValue.associate = models => {
		...
		AttributeValue.hasMany(models.ProductAttribute, {
